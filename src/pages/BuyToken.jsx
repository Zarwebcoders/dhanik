...
const BuyToken = () => {
    ...
    const fetchPlatformSettings = async () => {
        try {
            const res = await fetch(`${BASE_URL}/api/token/settings`);
            if (res.ok) {
    ...
    const fetchHistory = async () => {
        try {
            ...
            const res = await fetch(`${BASE_URL}/api/token/history`, {
    ...
    const handleConfirmPurchase = async () => {
        ...
        try {
            ...
            const response = await fetch(`${BASE_URL}/api/token/purchase`, {
                method: 'POST',
                headers: {
